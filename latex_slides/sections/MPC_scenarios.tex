...
\section{MPC scenarios, open loop}
...
\begin{frame}{Scenario 1: Reference control}
    \begin{columns}
        ...
        Objective:
        \begin{align*}
            \phi(t) = \int_{t_0}^{t_f} \left( (\eta(t) - \eta_{\text{ref}})^2 + \lambda_F \, (dF)^2 \right) dt,
        \end{align*}
...
\begin{frame}{Scenario 1A: Reference control w. changing inlet flue gas flow rate}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.75\textwidth]{../figures/MPC_scenario01A.pdf}
...
\begin{frame}{Scenario 1B: Reference control w. changing reboiler duty}
    \begin{figure}
        \centering
        \includegraphics[width=0.75\textwidth]{../figures/MPC_scenario01B.pdf}
...
\begin{frame}{Scenario 1C: Reference control w. changing reference and flue gas inlet \ce{CO2} concentration}
    \begin{figure}
        \centering
        \includegraphics[width=0.75\textwidth]{../figures/MPC_scenario01C.pdf}
...
\begin{frame}{Scenario 2: EMPC with varying electricity price}
    \begin{columns}
        ...
        \begin{align*}
            ...
            + \overbrace{\lambda_F \, (dF)^2 + \lambda_Q \, (dQ)^2}^{\textit{input change}})\,dt \\ &\quad + \overbrace{\lambda_s (s)^2}^{\textit{slack var.}},
        \end{align*}
...
\begin{frame}{Scenario 2A: EMPC with varying electricity price}
    Price sensitivity: Yes.
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth]{../figures/MPC_scenario02A.pdf}
        %\caption{MPC scenario 2: EMPC with varying electricity price.}
    \end{figure}
    
\end{frame}

\begin{frame}{Scenario 2B: MPC with no electricity price in objective}
Price sensitivity: No.
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth]{../figures/MPC_scenario02B.pdf}
        %\caption{MPC scenario 2: EMPC with varying electricity price.}
    \end{figure}
    
\end{frame}

\begin{frame}{Scenario 2C: MPC with no electricity price in objective}
Price sensitivity: No.
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth]{../figures/MPC_scenario02C.pdf}
        %\caption{MPC scenario 2: EMPC with varying electricity price.}
    \end{figure}
    
\end{frame}

    \begin{frame}{Scenario 2D: MPC with electricity price in objective}
    Price sensitivity: Yes.
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth]{../figures/MPC_scenario02D.pdf}
        %\caption{MPC scenario 2: EMPC with varying electricity price.}
    \end{figure}
    
\end{frame}

    \begin{frame}{Scenario 2E: MPC with no electricity price in objective}
Price sensitivity: No.
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth]{../figures/MPC_scenario02E.pdf}
        %\caption{MPC scenario 2: EMPC with varying electricity price.}
    \end{figure}
    
\end{frame}

\begin{frame}{Simulations with constant F and Q}
    Same time horizon, disturbances, electricity prices and CO2 prices as in scenario 2.
    \begin{columns}
    \column{0.5\textwidth}
         \begin{figure}
        \centering
        \includegraphics[width=1\textwidth]{../figures/cap_eff_vs_F_Q.pdf}
    \end{figure}
    \column{0.5\textwidth}
         \begin{figure}
        \centering
        \includegraphics[width=1\textwidth]{../figures/profit_vs_F_Q.pdf}
    \end{figure}
    \end{columns}
   
\end{frame}

\begin{frame}{Profit vs minimum capture efficiency requirement}
    \begin{figure}
        \centering
        \includegraphics[width=0.70\textwidth]{../figures/profit_vs_eta_min.pdf}
    \end{figure}
