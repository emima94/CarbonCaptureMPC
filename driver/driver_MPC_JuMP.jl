...
Nd_vals_F = [evaluate_NN(ND_params, [2.63, 0.6, F, 22])[1] for F in F_val]
plot(F_val, Nd_vals_F, xlabel="F", ylabel="Nd", title="Nd vs F", ylims = (0,1500))
...
F_val = range(0.22, 0.32, length=100)
Q_val = range(22,35, length=100)
